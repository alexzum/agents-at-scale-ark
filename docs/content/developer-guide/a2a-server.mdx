...
- **[Basic A2A Server](samples/a2a/basic-a2a-server/)**: Minimal 80-line A2A server with echo functionality
- **[Simple A2A Server](samples/a2a/simple-a2a-server/)**: Full-featured server with conversation, math, and echo capabilities
- **[Hosted LangChain Agents](samples/agent-hosting/hosted-langchain-agents/)**: LangChain weather agent with NWS API tools
