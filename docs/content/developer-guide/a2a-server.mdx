...
- **[Simple Agent](https://github.com/mckinsey/agents-at-scale-ark/tree/main/samples/a2a/simple-agent)**: Complete A2A server with conversation, math, and echo capabilities
- **[Weather Agent](https://github.com/mckinsey/agents-at-scale-ark/tree/main/samples/a2a/weather-agent)**: Weather agent with real API integrations
