---
title: Services
description: "Overview of ARK services: installation, manifest format, exposure, and discovery annotations"
---
...
- [A2A Gateway](/developer-guide/services/a2a-gateway) - Agent-to-Agent Gateway implementing A2A protocol
- [ARK Cluster Memory](/developer-guide/services/ark-cluster-memory) - In-memory storage with SSE streaming support
- [Execution Engine](/developer-guide/services/langchain-execution-engine) - Framework adapter for Langchain and other AI frameworks
