...
func (in *QueryStatus) DeepCopyInto(out *QueryStatus) {
	*out = *in
	...
	if in.TeamResponses != nil {
		in, out := &in.TeamResponses, &out.TeamResponses
		*out = make([]TeamResponse, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TeamResponse) DeepCopyInto(out *TeamResponse) {
	*out = *in
	if in.ToolCalls != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TeamResponse.
func (in *TeamResponse) DeepCopy() *TeamResponse {
	if in == nil {
		return nil
	}
